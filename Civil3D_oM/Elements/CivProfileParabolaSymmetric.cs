...
namespace BH.oM.Civils.Elements
{
    public class CivProfileParabolaSymmetric : BHoMObject, ICivProfileEntity
    {
        ...
        public virtual double GradeAtThroughPoint1 { get; set; } = 0;

        public virtual double GradeAtThroughPoint2 { get; set; } = 0;
        ...
        public virtual double ThroughPoint3Elevation { get; set; } = 0;

        public virtual double ThroughPoint3Station { get; set; } = 0;
